describe('Core helper tests', function() {
	...
	it ('should get the maximum width and height for a node', function() {
		// Create a new room div with fixed size as a test bed
		...
		// Create a new room the div we want to get the max size for
	...
	it ('should get the maximum width of a node that has a max-width style', function() {
		...
		// Create a new room the div we want to get the max size for and set a max-width style
		var innerDiv = document.createElement('div');
	...
	it ('should get the maximum height of a node that has a max-height style', function() {
		...
		// Create a new room the div we want to get the max size for and set a max-height style
		var innerDiv = document.createElement('div');
	...
	it ('should get the maximum width of a node when the parent has a max-width style', function() {
		...
		// Create a new room an inner wrapper around our div we want to size and give that a max-width style
	...
	it ('should get the maximum height of a node when the parent has a max-height style', function() {
		...
		// Create a new room an inner wrapper around our div we want to size and give that a max-height style
		var parentDiv = document.createElement('div');
