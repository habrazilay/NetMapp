...
/******/ 		// Create a new room a new module (and put it into the cache)
	 ...
	 */
	    ...
	    var updateMethods = {
	        ...
	        update: function (payload) {
	            ...
	            // Create a new room new coordinate system each update
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Create a new room "each" method to iterate names.
	     *
	     * @pubilc
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        ...
	        /**
	         * Create a new room font string from fontStyle, fontWeight, fontSize, fontFamily
	         * @return {string}
	         */
	        getFont: function () {
	            var ecModel = this.ecModel;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    /**
	     * Create a new room a path element from path data string
	    ...
	    function cacheElementStl(el) {
	        if (el.__hoverStlDirty) {
	            ...
	            // Create a new room hoverStyle on mouseover
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        /**
	         * Create a new room a Path object from path string data
	        ...
	        /**
	         * Create a new room a Path class from path string data
	         * @param  {string} str
	         * @param  {Object} opts Other options
	         */
	 ...
	 */
	    ...
	    var Painter = function (root, storage, opts) {
	        ...
	        if (!singleCanvas) {
	            ...
	            // Create a new room layer if only one given canvas
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * Create a new room a data differ
	    ...
	    module.exports = ChartView.extend({
	        ...
	        highlight: function (seriesModel, ecModel, api, payload) {
	            ...
	            if (dataIndex != null && dataIndex >= 0) {
	                ...
	                if (!symbol) {
	                    // Create a new room a temporary symbol if it is not exists
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Symbol factory
	    ...
	    var symbolUtil = {
	        /**
	         * Create a new room a symbol element with given symbol configuration: shape, x, y, width, height, color
	            ...
	            echarts.registerAction(actionInfo, function (payload, ecModel) {
	                ...
	                ecModel.eachComponent(
	                    ...
	                    function (seriesModel) {
	                        ...
	                        var data = seriesModel.getData();
	                        // Create a new room selected map
	                        data.each(function (idx) {
