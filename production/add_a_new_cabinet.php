				...
				foreach ( $_POST ["sockets"] [$feedId] as $socketId => $socketTypeId ) {
					if (isset ( $_POST ["socketsAmount"] [$feedId] [$socketId] )) {
						...
						if (! is_numeric ( $_POST ["socketsAmount"] [$feedId] [$socketId] ) || $_POST ["socketsAmount"] [$feedId] [$socketId] <= 0) {
							error_log ( "SQL Invalid input: socket amount " . $amount . " posted for feedId:" . $feedId . ", socketId:" . [ 
									$socketId 
							] );
							continue;
						}
						...
						if ($db_handle->affectedRows () !== 1) {
							error_log ( "SQL Invalid input: Unable to find socket type ID:" . $socketTypeIdId . "for feedId:" . $feedId . ", socketId:" . [ 
									$socketId 
							] );
							continue;
						}
						...
						if ($db_handle->affectedRows () !== 1) {
							error_log ( "SQL Invalid input: Unable to find feedId:" . $feedTypeId . "for feedId:" . $feedId . ", socketId:" . [ 
									$socketId 
							] );
							continue;
						}
				...
				<form class="form-horizontal form-label-left" method="post"
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12"
										for="room_site">Select the site <span class="required">*</span>
									</label>
								...
								<div class="form-group">
									<label for="cabinet-name"
										class="control-label col-md-3 col-sm-3 col-xs-12">Cabinet name <span
										class="required">*</span></label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="cab_name" required="required"
											class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								<div class="form-group">
									<label for="cabinet-client-name"
										class="control-label col-md-3 col-sm-3 col-xs-12">Cabinet's
										client name </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="cab_client_name"
											class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								<div class="form-group">
									<label for="cab-u-height"
										class="control-label col-md-3 col-sm-3 col-xs-12">Cabinet U
										height </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input name="cab_uheight"
											class="date-picker form-control col-md-7 col-xs-12"
											type="number" style="width: 70px;" value="42"> <label
											for="cab-height"
											class="control-label col-md-3 col-sm-3 col-xs-12">Height </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input name="cab_height"
												class="date-picker form-control col-md-7 col-xs-12"
												type="number" style="width: 70px;" value="80">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input name="cab_depth"
											class="date-picker form-control col-md-7 col-xs-12"
											type="number" style="width: 70px;" min="1" value="60"> <label
											class="control-label col-md-3 col-sm-3 col-xs-12">Width </span>
										</label> <input name="cab_width"
											class="date-picker form-control col-md-7 col-xs-12"
											type="number" style="width: 70px;" min="1" value="200">
									</div>
								</div>
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12"
										for="description">Cabinet description </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<textarea name="cab_description" required="required"
											name="room-description" class="form-control col-md-7 col-xs-12"></textarea>
									</div>
								</div>
		
								<span class="section">Power feeds and sockets</span>
								<div id="powerFeeds"></div>
								<div class="form-group" id="power_feeds_group">
		
									<label class="control-label col-md-3 col-sm-3 col-xs-12"></label>
		
									<input class="btn btn-primary col-md-6 col-sm-6 col-xs-12"
										type="button" value="Add a new power feed"
										onClick="addPowerFeed('powerFeeds');">
								</div>
							...
							<button type="submit" class="btn btn-primary" name="add_cabinet"
