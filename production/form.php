        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-sitemap"></i> <span>NetMapp </span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Project (Name) <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Details</a></li>
                      <li><a href="index2.html">Contacts</a></li>
                      <li><a href="index3.html">Objectives</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Rooms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">All Rooms</a></li>
                        <li><a href="form_advanced.html">Room1</a></li>
                        <li><a href="form_validation.html">Room2</a></li>                      
                        <li><a href="form_upload.html">Room 3 </a></li>
                        <li><a href="form_buttons.html">Room 4</a></li>
                        <li><a href="create_a_new_room.html">Create a new room</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Devices <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">Switches</a></li>
                      <li><a href="media_gallery.html">Hubs</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Cabinets <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Cabinets</a></li>
                      <li><a href="tables_dynamic.html">Table Dynamic</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Work Performance <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-clone"></i>Exceptions <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="pricing_tables.html">Pricing Cabinets</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/profilepic.jpg" alt="">Daniel Schmidt
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="images/profilepic.jpg" alt="Profile Image" /></span>
                        <span>
          ...
          <div class="">
            ...
            <div class="row">
                      ...
                      <p style="padding: 5px;">
                        ...
                        <p>
                          ...
                          <select id="heard" class="form-control" required>
                            ...
                            <option value="what">isThis</option>
                            <?php 
                            ...
                            echo "\n\t\t\t\t\t\t\t";
                            echo "<option id=\"" . $row['id'] . "\" value=\"room\">" . $row['name'] . "</option>";
                            }
                            echo "\n";
                            ?>
                          </select>
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Room4 <small>Sessions</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
